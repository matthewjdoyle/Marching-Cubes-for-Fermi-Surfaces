...
def process_lattice(lat_id, lat_info):
    ...
    # Use optimized 50^3 mesh for fluid real-time 3D marching cubes video generation
    npts_mesh_vid = 50
    ...
    video_out_path = os.path.join(OUTPUT_DIR, f"fermi_surface_evolution_{lat_id}.mp4")
    print(f"Generating Fermi Surface Evolution Video ({TOTAL_FRAMES} frames)...")
